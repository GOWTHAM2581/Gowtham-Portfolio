  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-8 sm:gap-12 text-center md:text-left">
        ...
        {/* Right - Text Content */}
        <div className="flex flex-col justify-center md:w-2/3 px-2 sm:px-0 text-left">
          ...
          <p className="text-gray-400 leading-relaxed text-sm sm:text-[0.95rem] md:text-base mb-4 text-justify md:text-left">
            I am a passionate{" "}
          ...
          {showMore && (
            <>
              ...
              <p className="text-gray-400 leading-relaxed mb-8 text-justify md:text-left">
